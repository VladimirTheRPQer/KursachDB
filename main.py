...
class QLabelBuddy(QDialog):
   ...
   def initUI(self):
      ...
      self.label11 = QLabel('Напишите число', self)
      self.label21 = QLabel('Напишите число', self)
      self.label31 = QLabel('Напишите число', self)
      self.label41 = QLabel('Напишите число', self)
      self.label51 = QLabel('Напишите число', self)
      self.label61 = QLabel('Напишите число', self)
